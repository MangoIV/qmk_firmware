...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_QWERTY] = KEYMAP(
		...
		LCTL(KC_S), KC_DEL, KC_LGUI, KC_LCTL, KC_LALT, KC_BSPC, KC_SPC, KC_ENT, MO(_LOWER), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT
		),
	[_LOWER] = KEYMAP(
		KC_CAPS, KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_EQL,
		XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, XXXXXXX, KC_BSLS, 
		XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_HOME, KC_END, KC_PGUP, KC_PGDN, XXXXXXX, KC_RSFT, 
